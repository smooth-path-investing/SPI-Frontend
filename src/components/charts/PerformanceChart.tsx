...
const performanceData = [
  ...
  { date: '2018-06', smoothPath: 120.37, sp500: 115.1, month: 'Jun 2018' },
  ...
  { date: '2018-11', smoothPath: 123.17, sp500: 117.7, month: 'Nov 2018' },
  ...
  { date: '2019-03', smoothPath: 128.67, sp500: 121.8, month: 'Mar 2019' },
  ...
  { date: '2020-04', smoothPath: 144.5, sp500: 127.6, month: 'Apr 2020' },
  ...
  { date: '2021-01', smoothPath: 227.8, sp500: 164.97, month: 'Jan 2021' },
          ...
          <div className="space-y-2">
            <div className="pb-2 border-b border-border">
              <p className="text-xs text-muted-foreground mb-1">
                {textContent['home-performance-chart-legend-smooth-path']}
              </p>
              <p className="font-bold text-lg" style={{ color: '#FFD700' }}>
                {smoothPathReturnNum >= 0 ? '+' : ''}
                {smoothPathReturn}%
              </p>
            ...
            <div>
              <p className="text-xs text-muted-foreground mb-1">
                {textContent['home-performance-chart-legend-sp500']}
              </p>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm text-muted-foreground">
            {textContent['home-performance-chart-subtitle']}
          </p>
