...
export const SectionHeader = ({
  ...
  return (
    <div className={`text-center mb-10 sm:mb-14 ${className}`}>
      <h2 className="text-3xl sm:text-4xl lg:text-[2.9rem] font-semibold tracking-[-0.03em] leading-[1.08] text-[var(--foreground)] mb-4 sm:mb-5 max-w-4xl mx-auto text-balance">
        {mainText}
