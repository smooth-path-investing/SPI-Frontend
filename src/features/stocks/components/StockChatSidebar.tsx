...
export const StockChatSidebar: React.FC<StockChatSidebarProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 z-40 w-[min(100vw,400px)] border-l border-white/12 bg-[linear-gradient(180deg,rgba(12,12,12,0.98),rgba(0,0,0,0.97))] shadow-[0_26px_52px_rgba(0,0,0,0.3)] backdrop-blur-xl transition-transform duration-300 ease-in-out lg:w-[min(1000px,82vw)] ${panelPositionClass} ${
