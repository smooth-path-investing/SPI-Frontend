...
export const NAVIGATION_ITEMS: INavItem[] = [
  ...
  { label: 'Historical Stocks', href: '/performance' },
...
export const TEAM_MEMBERS: ITeamMember[] = [
  {
    ...
    portfolio: {
      description:
        'Ramy leads our quantitative research team and has developed proprietary factor models that consistently outperform market benchmarks.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Fadel architected our AI-driven stock selection system, combining deep learning with traditional financial analysis.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Karim ensures our strategies maintain optimal risk-adjusted returns through sophisticated portfolio construction and hedging techniques.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Jason provides comprehensive market analysis and strategic insights to support our investment decision-making process.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Sarah leads our research initiatives, identifying new market opportunities and developing innovative investment strategies.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Michael harnesses big data and advanced analytics to uncover market signals invisible to traditional analysis.',
      achievements: [
  ...
  },
  {
    ...
    portfolio: {
      description:
        'Emily designs and optimizes our portfolio construction strategies, ensuring consistent risk-adjusted performance across market cycles.',
      achievements: [
